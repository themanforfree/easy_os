...
lazy_static! {
    static ref APP_MANAGER: UPSafeCell<AppManager> = unsafe {
        UPSafeCell::new({
            ...
            let num_apps = num_app_ptr.read_volatile();
...
pub fn run_next_app() -> ! {
    ...
    unsafe extern "C" {
        unsafe fn userret(cx_addr: usize);
    }
    unsafe {
        userret(
            KERNEL_STACK.push_context(TrapFrame::new(APP_BASE_ADDRESS, USER_STACK.get_sp()))
                as *const _ as usize,
        );
    }
